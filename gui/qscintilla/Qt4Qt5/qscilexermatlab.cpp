...
QColor QsciLexerMatlab::defaultColor(int style) const
{
    ...
    case Command:
        return QColor(169,226,243); //QColor(0x7f,0x7f,0x00);

    case Number:
        return QColor(0x00,0x7f,0x7f);

    case Keyword:
        return QColor(0,0,214); //return QColor(0x00,0x00,0x7f);

    case KeywordAPI:
        return QColor(33,65,154);

//    case Identifier:
//        return QColor(0,100,159);

    //case Keyword2:
    //    return QColor(169,226,243);
...
QString QsciLexerMatlab::description(int style) const
{
    ...
    case OctaveComment:
        return tr("Octave-style comment");
...
const char * QsciLexerMatlab::blockStartKeyword(int *style)
{
  if (style)
        *style = Keyword;

    return "else for if elseif while try catch function switch";

}

const char *QsciLexerMatlab::blockEndKeyword(int *style)
{
  if (style)
        *style = Keyword;
...
int QsciLexerMatlab::braceStyle() const
{
    return Operator;
}

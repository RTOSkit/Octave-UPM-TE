...
#include <QsciOctUPM/qsciglobal.h>
#include <QsciOctUPM/qscilexer.h>
...
public:
	...
	//! An Octave-style comment
	OctaveComment = 9,

	//! A keyword from the API
	KeywordAPI = 10
    };
    ...
    const char * blockStartKeyword(int *style);
    const char * blockEndKeyword(int *style);

...
QString Parser::nodeTextToHtml(QString text, int anchorPos, QString anchor)
{
	...
	QString navigationLinksTop= QString(
		"<p style='font-size: 80%;'><b>Prev topic:</b> <a href='%2'>%3</a><br>"
		"<b>Next topic:</b> <a href='%4'>%5</a><br>"
		"<b>Up:</b> <a href='%6'>%7</a><br></p>\n"
		"<h2><u>%1</u></h2><br>"
		)
		.arg(nodeName)
	...
	QString navigationLinksBottom= QString(
		"<b>Prev topic:</b> <a href='%2'>%3</a><br>"
		"<b>Next topic:</b> <a href='%4'>%5</a><br>"
		"<b>Up:</b> <a href='%6'>%7</a><br><br>\n"
		)
		.arg(nodeName)
		.arg(QString(QUrl::toPercentEncoding(nodePrev,"","'")))
		.arg(nodePrev)
	...
	text.prepend(navigationLinksTop);
	text.append(navigationLinksBottom);

...
WebInfo::WebInfo(QWidget *parent):QWidget(parent)
{
	...
	QHBoxLayout *bottom_hboxLayout=new QHBoxLayout();
	layout->addLayout(bottom_hboxLayout);
	
	searchLineEdit=new QLineEdit(this);
	bottom_hboxLayout->addWidget(searchLineEdit);

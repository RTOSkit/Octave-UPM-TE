...
resource_manager::reload_settings ()
{
  ...
  set_settings(_home_path + "/.config/octave-upm/settings");
}
...
resource_manager::set_settings (QString file)
{
  ...
  {
    _first_run = true;
    QFile origsettings("config/settings");
    QDir destdir(_home_path + "/.config/octave-upm");
    if (!destdir.exists ())
      QDir().mkpath(destdir.absolutePath());
    origsettings.copy (file);
  }
...
{
  _icons [resource_manager::octave] = QIcon (":/images/media/logo.png");
  _icons [resource_manager::copy] = QIcon (":/icons/media/Copy-icon.png");
  _icons [resource_manager::cut] = QIcon (":/icons/media/cut-icon.png");
  _icons [resource_manager::paste] = QIcon (":/icons/media/Paste-icon.png");
}

const char*
resource_manager::matlab_keywords ()
{
  return
      ".nargin. "
      "EDITOR "
